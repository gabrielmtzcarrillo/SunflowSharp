...
namespace SunflowSharp.Systems
{
    public class ByteUtil
    {
        ...
        public static byte[] get8Bytes(long i)
        {
            ...
            b[0] = (byte)(i & 0xFF);
            b[1] = (byte)((long)((long)i >> 8) & (long)0xFF);
            b[2] = (byte)((long)((long)i >> 16) & (long)0xFF);
            b[3] = (byte)((long)((long)i >> 24) & (long)0xFF);

            b[4] = (byte)((long)((long)i >> 32) & (long)0xFF);
            b[5] = (byte)((long)((long)i >> 40) & (long)0xFF);
            b[6] = (byte)((long)((long)i >> 48) & (long)0xFF);
            b[7] = (byte)((long)((long)i >> 56) & (long)0xFF);
        ...
        {
            return (long)(((ulong)(toInt(input[0], input[1], input[2], input[3]))) | ((ulong)(toInt(input[4], input[5], input[6], input[7])) << 32));
        }
