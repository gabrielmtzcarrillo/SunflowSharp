...
namespace SunflowSharp.Maths
{
    ...
    {
        private static float P1x = 0.34f;
        private static float P1y = 0.66f;
        private static float P1z = 0.237f;
        private static float P2x = 0.011f;
        private static float P2y = 0.845f;
        private static float P2z = 0.037f;
        private static float P3x = 0.34f;
        private static float P3y = 0.12f;
        private static float P3z = 0.9f;

        public static Vector3 snoise(float x)
        {
            return new Vector3(PerlinScalar.snoise(x + P1x), PerlinScalar.snoise(x + P2x), PerlinScalar.snoise(x + P3x));
        }

        public static Vector3 snoise(float x, float y)
        {
            return new Vector3(PerlinScalar.snoise(x + P1x, y + P1y), PerlinScalar.snoise(x + P2x, y + P2y), PerlinScalar.snoise(x + P3x, y + P3y));
        }

        public static Vector3 snoise(float x, float y, float z)
        {
        ...
        public static Vector3 snoise(float x, float y, float z, float t)
        {
        ...
        public static Vector3 snoise(Point2 p)
        {
            return snoise(p.x, p.y);
        }

        public static Vector3 snoise(Point3 p)
        {
            return snoise(p.x, p.y, p.z);
        }

        public static Vector3 snoise(Point3 p, float t)
        {
            return snoise(p.x, p.y, p.z, t);
        }

        public static Vector3 noise(float x)
        {
        ...
        public static Vector3 noise(float x, float y, float z)
        {
        ...
        public static Vector3 noise(float x, float y, float z, float t)
        {
        ...
        public static Vector3 noise(Point3 p)
        {
            return noise(p.x, p.y, p.z);
        }

        public static Vector3 noise(Point3 p, float t)
        {
            return noise(p.x, p.y, p.z, t);
        }

        public static Vector3 pnoise(float x, float period)
        {
            return new Vector3(PerlinScalar.pnoise(x + P1x, period), PerlinScalar.pnoise(x + P2x, period), PerlinScalar.pnoise(x + P3x, period));
        }

        public static Vector3 pnoise(float x, float y, float w, float h)
        {
        ...
        public static Vector3 pnoise(float x, float y, float z, float w, float h, float d)
        {
        ...
        public static Vector3 pnoise(float x, float y, float z, float t, float w, float h, float d, float p)
        {
        ...
        public static Vector3 pnoise(Point3 p, Vector3 period)
        {
            return pnoise(p.x, p.y, p.z, period.x, period.y, period.z);
        }

        public static Vector3 pnoise(Point3 p, float t, Vector3 pperiod, float tperiod)
        {
            return pnoise(p.x, p.y, p.z, t, pperiod.x, pperiod.y, pperiod.z, tperiod);
        }

        public static Vector3 spnoise(float x, float period)
        {
            return new Vector3(PerlinScalar.spnoise(x + P1x, period), PerlinScalar.spnoise(x + P2x, period), PerlinScalar.spnoise(x + P3x, period));
        }

        public static Vector3 spnoise(float x, float y, float w, float h)
        {
        ...
        public static Vector3 spnoise(float x, float y, float z, float w, float h, float d)
        {
        ...
        public static Vector3 spnoise(float x, float y, float z, float t, float w, float h, float d, float p)
        {
        ...
        public static Vector3 spnoise(Point2 p, float periodx, float periody)
        {
            return spnoise(p.x, p.y, periodx, periody);
        }

        public static Vector3 spnoise(Point3 p, Vector3 period)
        {
            return spnoise(p.x, p.y, p.z, period.x, period.y, period.z);
        }

        public static Vector3 spnoise(Point3 p, float t, Vector3 pperiod, float tperiod)
        {
