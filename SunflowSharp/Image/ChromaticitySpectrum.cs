...
namespace SunflowSharp.Image
{
     ...
     */
    public class ChromaticitySpectrum : SpectralCurve
    {
        private static float[] S0Amplitudes = { 0.04f, 6.0f, 29.6f, 55.3f,
        ...
        private static float[] S1Amplitudes = { 0.02f, 4.5f, 22.4f, 42.0f,
        ...
        private static float[] S2Amplitudes = { 0.0f, 2.0f, 4.0f, 8.5f, 7.8f,
        ...
        private static RegularSpectralCurve kS0Spectrum = new RegularSpectralCurve(S0Amplitudes, 300, 830);
        private static RegularSpectralCurve kS1Spectrum = new RegularSpectralCurve(S1Amplitudes, 300, 830);
        private static RegularSpectralCurve kS2Spectrum = new RegularSpectralCurve(S2Amplitudes, 300, 830);

        private static XYZColor S0xyz = kS0Spectrum.toXYZ();
        private static XYZColor S1xyz = kS1Spectrum.toXYZ();
        private static XYZColor S2xyz = kS2Spectrum.toXYZ();
