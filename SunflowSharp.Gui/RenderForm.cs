...
namespace SunflowSharp.Gui
{
    public partial class RenderForm : Form, IDisplay
    {
        ...
        private void Render()
        {
            api = new GuiApi("gumbo_and_teapot.sc.gz");
            api.build();
        ...
        public delegate void imageUpdateDelegate(int x, int y, int w, int h, Image.Color[] data);
        ...
        public void imageFill(int x, int y, int w, int h, Image.Color c)
        {
            lock (bitmap)
            {
