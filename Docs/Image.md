...
## catmull-rom blackman-harris

![Image from page 9](images/page9_img1.png)

![Image from page 9](images/page9_img2.png)

![Image from page 9](images/page9_img3.png)

![Image from page 9](images/page9_img4.png)

![Image from page 9](images/page9_img5.png)

![Image from page 9](images/page9_img6.png)
...
![Image from page 10](images/page10_img1.png)

![Image from page 10](images/page10_img2.png)

![Image from page 10](images/page10_img3.png)
...
The SVN 0.07.3 version of Sunflow create alpha channels when exporting to png or tga. Alphas will be recognized

in textures in future releases.

## Banding

In some cases, and rendered image with a somewhat uniform color will appear to have a banding affect and not be

a smooth gradient. The issue is due to the 8 bits per channel used in the rendered image causing "mach banding" (an

effect of the human eye) that happens just when values jump from one integer to the next after staying constant for

several pixels. In this case the only solution found so far is to use dithering (which only seems to be found in

Photoshop) when converting to 24 bit RGB.
